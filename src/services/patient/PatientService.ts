...
export class PatientService {
	static async createPatient(
		...
		try {
			...
			console.log("🔵 [PatientService] dbPatient prepared:", dbPatient);
			...
			console.log("✅ [PatientService] Patient created:", data);
			...
			console.error("❌ [PatientService] Exception:", error);
			return {success: false, error: error.message};
		}
	}
	...
	static async updatePatient(
		...
		try {
			...
			if (updates.goals !== undefined)
				dbUpdates.goals = updates.goals ? JSON.stringify(updates.goals) : null;
			if (updates.secondaryPhone !== undefined)
				dbUpdates.secondaryphone = updates.secondaryPhone || null;
