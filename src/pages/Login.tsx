...
const Login = () => {
  ...
  const { isAuthenticated, isLoading: authLoading, login, signInWithGoogle } = useAuth();
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Não precisamos navegar aqui porque o Supabase redirecionará após a autenticação
    } catch (error: any) {
      console.error("Erro ao processar login com Google:", error);
      // Toast já é tratado na função signInWithGoogle
    } finally {
