...
const ENP_MEAL_DISTRIBUTION = [
  { name: 'Café da Manhã', time: '07:00', percentage: 25, description: 'Refeição principal matinal' },
...
export const MealDistributionENP: React.FC<MealDistributionENPProps> = ({
  vet,
  macros
}) => {
    ...
    <Card>
        ...
        <CardTitle className="flex items-center">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">Distribuição padrão ENP:<br/>
                Café 25% | Lanche M 10% | Almoço 30%<br/>
                Lanche T 10% | Jantar 20% | Ceia 5%</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </CardTitle>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-gray-600">
                P: {macros.protein.grams}g | C: {macros.carbs.grams}g | G: {macros.fat.grams}g
              </div>
            </div>
          </div>
        </div>
            ...
            <div key={meal.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{meal.time} • {meal.description}</p>
                </div>
        ...
        <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
          <strong>Padrão ENP:</strong> Distribuição baseada em estudos de cronobiologia nutricional.
          Café da manhã e almoço concentram maior aporte calórico para otimizar metabolismo diurno.
        </div>
      </CardContent>
    </Card>
  );
