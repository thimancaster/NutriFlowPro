							...
							<div className="flex items-start gap-2">
								...
								<div className="text-sm text-primary/90">
									<p className="font-medium mb-1">
										Medidas opcionais para cálculos mais precisos:
									</p>
									<ul className="text-xs space-y-1">
										<li>
											• <strong>Cintura e Quadril:</strong> Para cálculo da
											RCQ (Relação Cintura-Quadril)
										</li>
										<li>
											• <strong>Dobras Cutâneas:</strong> Para % de gordura
											corporal pelo método Jackson-Pollock
										</li>
									</ul>
								</div>
							</div>
						...
						<div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
							<div className="text-sm text-gray-600">
								...
								<ul className="list-disc list-inside mt-1 space-y-1 text-xs">
									<li>
										<strong>Homens:</strong> Peitoral, Abdominal, Coxa
									</li>
									<li>
										<strong>Mulheres:</strong> Tricipital, Suprailíaca, Coxa
									</li>
								</ul>
							</div>
						</div>
