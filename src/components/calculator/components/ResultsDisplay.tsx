	...
	return (
		<div className="space-y-6">
			...
			<div className="flex justify-between items-center">
				...
				<Badge className={getObjectiveBadgeColor(objective)}>{objective}</Badge>
			</div>
				...
				<Card>
					<CardContent className="p-4">
						<div className="text-center">
							...
							<p className="text-2xl font-bold text-primary">{teeObject.get}</p>
					...
					<CardContent className="p-4">
						<div className="text-center">
							...
							<p className="text-2xl font-bold">
								{Math.abs(calorieSummary.difference)}
							</p>
				...
				<CardContent>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<div className="text-center p-4 bg-purple-500/10 rounded-lg">
							...
							<p className="text-sm text-muted-foreground">{macros.fat.kcal} kcal</p>
							<p className="text-xs text-muted-foreground">
