    ...
    return (
      <input
        ...
        className={cn(
          ...
          "hover:shadow-sm hover:bg-gradient-to-r hover:from-transparent hover:to-primary/5 hover:scale-[1.01]",
          "focus:bg-gradient-to-r focus:from-primary/5 focus:to-transparent focus:scale-[1.02] focus:shadow-md",
