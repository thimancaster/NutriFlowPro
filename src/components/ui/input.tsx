		...
		return (
			<input
				...
				className={cn(
					...
					"dark:bg-dark-bg-surface/60 dark:border-dark-border-primary/60 dark:text-dark-text-primary dark:placeholder:text-dark-text-muted dark:ring-offset-dark-bg-primary",
					...
					"dark:hover:border-dark-accent-green dark:hover:to-dark-accent-green/5 dark:hover:shadow-dark-glow",
					"focus:border-nutri-blue focus:bg-gradient-to-r focus:from-nutri-blue/5 focus:to-transparent focus:scale-[1.02]",
					"dark:focus:border-nutri-blue dark:focus:from-nutri-blue/5 dark:focus:ring-nutri-blue/50",
					className
				)}
				ref={ref}
				{...props}
