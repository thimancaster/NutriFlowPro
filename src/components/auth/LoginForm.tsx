      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="seuemail@exemplo.com" autoComplete="email" disabled={isSubmitting} className="h-12 text-base bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-white focus:ring-white/50" {...field} />
                </FormControl>
          ...
          field
                ...
                <FormControl>
                  <Input type="password" autoComplete="current-password" disabled={isSubmitting} placeholder="Digite sua senha" className="h-12 text-base bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-white focus:ring-white/50" />
                </FormControl>
                <FormMessage className="text-red-200 text-sm font-medium" />
              </FormItem>} />
