...
const PricingFooter: React.FC<PricingFooterProps> = ({ className = "" }) => {
  return (
    <div className={`text-center mt-10 ${className}`}>
      <p className="text-gray-700 text-sm">Acesso imediato após a confirmação do pagamento</p>
      <p className="mt-2 text-gray-700 text-sm flex items-center justify-center">
