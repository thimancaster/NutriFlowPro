...
const MealPlanGenerator = () => {
  ...
  const generateMealPlan = () => {
    // The meal plan generation logic is moved to a separate function in MealGeneratorLogic
...
// Function to generate meal plan data
...
const generateMacros = (calories: number, dietType: string) => {
